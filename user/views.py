...
from user.forms import LoginForm, RegisterForm, UserUpdateForm, ProfileUpdateForm, ProductForm
    ...
    if request.user.is_superuser:
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                data.sale = form.cleaned_data['sale']
                data.salePrice = form.cleaned_data['salePrice']
